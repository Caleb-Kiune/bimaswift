...
export const activeCommercialProducts: CommercialInsuranceProduct[] = [
  ...
  // ==========================================
  {
    ...
    tpoBands: [
      { usageType: "OWN_GOODS", minTonnage: 0, maxTonnage: 3, flatPremium: 12000 },
      { usageType: "OWN_GOODS", minTonnage: 3.01, maxTonnage: 8, flatPremium: 15000 },
      { usageType: "OWN_GOODS", minTonnage: 8.01, maxTonnage: 15, flatPremium: 20000 },
      { usageType: "GENERAL_CARTAGE", minTonnage: 0, maxTonnage: 3, flatPremium: 20000 },
      { usageType: "GENERAL_CARTAGE", minTonnage: 3.01, maxTonnage: 15, flatPremium: 25000 },
    ],
    ...
    riders: [
      {
        ...
        isToggleable: true,
        bands: [{ minVehicleValue: 0, maxVehicleValue: 999999999, rateType: "PERCENTAGE_BPS", rateValue: 45, minPremium: 5000 }],
      },
      {
        id: "ncba_comm_ep",
        ...
        isToggleable: true,
        bands: [{ minVehicleValue: 0, maxVehicleValue: 999999999, rateType: "PERCENTAGE_BPS", rateValue: 50, minPremium: 5000 }],
      },
    ],
  },
  ...
  // ==========================================
  {
    ...
    tpoBands: [
      { usageType: "OWN_GOODS", minTonnage: 0, maxTonnage: 3, flatPremium: 12000, fleetPremium: 10000 },
      { usageType: "OWN_GOODS", minTonnage: 3.01, maxTonnage: 8, flatPremium: 15000, fleetPremium: 12500 },
      { usageType: "OWN_GOODS", minTonnage: 8.01, maxTonnage: 999, flatPremium: 20000, fleetPremium: 18000 },
      { usageType: "GENERAL_CARTAGE", minTonnage: 0, maxTonnage: 8, flatPremium: 20000, fleetPremium: 15000 },
      { usageType: "GENERAL_CARTAGE", minTonnage: 8.01, maxTonnage: 20, flatPremium: 25000, fleetPremium: 20000 },
    ],
    ...
    riders: [
      {
        ...
        name: "Political Violence & Terrorism",
        isToggleable: true,
        bands: [{ minVehicleValue: 0, maxVehicleValue: 999999999, rateType: "PERCENTAGE_BPS", rateValue: 35, minPremium: 3000 }],
      },
      {
        id: "geminia_comm_ep",
        type: "EXCESS_PROTECTOR",
