...
interface CommercialQuoteCardProps {
  quote: CommercialQuoteResult;
  isHistoryView?: boolean;
  onSaveQuote?: (quote: CommercialQuoteResult) => Promise<void>;
  isSaving?: boolean;
  isSaved?: boolean;
}

export default function CommercialQuoteCard({
  quote,
  isHistoryView = false,
  onSaveQuote,
  isSaving = false,
  isSaved = false,
}: CommercialQuoteCardProps) {
  ...
  return (
    <Accordion defaultValue={isHistoryView ? [quote.insurerId] : []} className="w-full">
      <AccordionItem
